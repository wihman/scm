		...
		<table class="table table-bordered">
			<tr style="background-color: #F0F0F0">
				...
				<div class="panel-heading" style="background-color:#204E8A;color:white">
                        		<h3 class="panel-title"><i class="fa fa-leaf"></i> Data Jenis</h3> 
				</td>
			</tr>
			<tr>
				<td>
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<?php 
						$no=0;
						$r=mysql_query("select * from tbl_jenis");
						while($r1=mysql_fetch_array($r)){
							$no++
					?>
					<tr>
						<td><?php echo $no ?></td>
						<td><?php echo $r1['nama_jenis'] ?></td>
						<td>
						<a href="home.php?hal=edit_jenis&id=<?php echo $r1['id'] ?>">
						<button class="btn btn-sm btn-warning"><span class="fa fa-edit"></span> Edit</button>
						</a>
						<a href="home.php?hal=hapus_jenis&id=<?php echo $r1['id'] ?>" onclick="return confirmhapus()">
...
<form method="POST" action="home.php?hal=simpan_jenis">
    ...
    <div class="modal-dialog">    
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #FF892A;color: white">
          ...
          <h4 class="modal-title"><span class="fa fa-leaf"></span> Tambah Data Jenis</h4>
        </div>
        <div class="modal-body">
          <table class="table">
          	<tr>
          		<td align="right">Nama Jenis</td>
          		<td>:</td>
          		<td><input type="text" class="form-control" name="nama_jenis"></td>
          	</tr>
          </table>
        </div>
