		...
		<table class="table table-bordered">
			<tr style="background-color: #F0F0F0">
				...
				<div class="panel-heading" style="background-color:#204E8A;color:white">
                        		<h3 class="panel-title"><i class="fa fa-bank"></i> Data Kecamatan</h3> 
				</td>
			</tr>
			<tr>
				<td>
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<?php 
						$no=0;
						$r=mysql_query("select * from tbl_kecamatan");
						while($r1=mysql_fetch_array($r)){
							$no++
					?>
					<tr>
						<td><?php echo $no ?></td>
						<td><?php echo $r1['nama_kecamatan'] ?></td>
						<td>
						<a href="home.php?hal=edit_kecamatan&id=<?php echo $r1['id'] ?>">
						<button class="btn btn-sm btn-warning"><span class="fa fa-edit"></span> Edit</button>
						</a>
						<a href="home.php?hal=hapus_kecamatan&id=<?php echo $r1['id'] ?>" onclick="return confirmhapus()">
...
<form method="POST" action="home.php?hal=simpan_kecamatan">
    ...
    <div class="modal-dialog">    
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #FF892A;color: white">
          ...
          <h4 class="modal-title"><span class="fa fa-bank"></span> Tambah Data Kecamatan</h4>
        </div>
